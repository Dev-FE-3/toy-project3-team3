...
> 👉 **[https://idollink.netlify.app](https://idollink.netlify.app)** – 지금 바로 나만의 플레이리스트를 만들어보세요!
...
| **프로젝트 기초 세팅**<br>유튜브 API 세팅<br>공통 컴포넌트 제작 (Input, Loading, Modal)<br>로그인/회원가입 페이지 개발<br>플레이리스트 제작 및 수정<br>테스트 코드 작성<br><br> | **Supabase 초기 세팅**<br>공통 컴포넌트 제작 (Nav bar, Header, Title, Scroll bar)<br>프로필/보관함/탐색 페이지 개발<br>영상 재생 페이지 퍼블리싱<br>테스트 코드 작성<br><br> | **DB 설계 및 API 세팅**<br>Axios를 활용한 API 연결<br>공통 컴포넌트 제작 (Select Box, Button)<br>플레이리스트 상세/영상 재생 페이지 개발<br>Playlist Card 컴포넌트 제작<br><br> |
